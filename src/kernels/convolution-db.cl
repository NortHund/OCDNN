...
__kernel void convolution_double_ocs(__global double* inputA, __global double* inputB, __global double* output, __global double* ocs, int heightA, int widthA, int depthA, int heightB, int widthB, int depthB, int layerA, int layerB) {
    int col = get_global_id(0);
    int row = get_global_id(1);
    int width = get_global_size(0);
    int height = get_global_size(1);
