...
public:
    ...
    void init_programs()
    {
        ...
        prog_cc = _ocl_base->CreateProgramFromFile("kernels/p5-cc.cl");
        prog_of = _ocl_base->CreateProgramFromFile("kernels/p5-of.cl");
    }
...
OCL_Phase5 ocl_phase5;

struct LoadImage : public IProgram
{
    int run() override
    {
        unsigned error = ocl_phase5.img0->load_image("../../source-img/im0.png");
        error = ocl_phase5.img1->load_image("../../source-img/im1.png");
        return (int) error;
    }
};
...
struct ResizeImage : public IProgram
{
    int run() override
    {
        ocl_phase5.img0->resize_image(scaling_factor);
        ocl_phase5.img1->resize_image(scaling_factor);
        return 0;
    }
};
...
struct TransformToGreyscale : public IProgram
{
    int run() override
    {
        ocl_phase5.img0->transform_to_grayscale();
        ocl_phase5.img1->transform_to_grayscale();
        return 0;
    }
};
...
struct SaveGreyscaleImage : public IProgram
{
    int run() override
    {
        unsigned error = ocl_phase5.img0->save_image("../../output-img/im0_grey.png");
        error = ocl_phase5.img1->save_image("../../output-img/im1_grey.png");
        return (int) error;
    }
};
...
struct SaveResizedImage : public IProgram
{
    int run() override
    {
        unsigned error = ocl_phase5.img0->save_image("../../output-img/im0_grey_resized.png");
        error = ocl_phase5.img1->save_image("../../output-img/im1_grey_resized.png");
        return (int) error;
    }
};
...
struct ZNCCResizedImage : public IProgram
{
    int run() override
    {
        int windowSize = 9;
        int maxDisparity = 65;
        ocl_phase5.ZNCC(windowSize, maxDisparity);
...
struct SaveZNCCImage : public IProgram
{
    int run() override
    {
        ocl_phase5.img0->save_image("../../output-img/im0_grey_resized_zncc.png");
        ocl_phase5.img1->save_image("../../output-img/im1_grey_resized_zncc.png");
        return 0;
    }
};
...
struct CrosscheckImage : public IProgram
{
    ...
    {
        int threshold = 50;
        ocl_phase5.crossCheck_Images(threshold);
...
struct SaveCrosscheckImage : public IProgram
{
    int run() override
    {
        ocl_phase5.img0->save_image("../../output-img/im0_grey_resized_zncc_cc.png");
        return 0;
    }
};
...
int main()
{
    ...
    std::cout << "Crosscheck images return result: " << result << std::endl;
    std::cout << "Elapsed time: " << Program_sw.getElapsedTime() << " us" << std::endl;
    ...
    ocl_phase5.print_kernel_execution_times();
